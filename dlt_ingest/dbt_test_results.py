...
def load_dbt_test_results(dbt_project_rel_path: str = "dbt") -> Iterator[dict[str, Any]]:
    """
    ...
    target_path = Path(__file__).parent.parent / dbt_project_rel_path / "target"
...
def run_pipeline(dbt_project_rel_path: str = "dbt") -> None:
    """
    ...
    load_info = pipeline.run(
        load_dbt_test_results(dbt_project_rel_path),
